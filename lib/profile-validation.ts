...
export const profileSchema = z.object({
  ...
  work_experience: z.array(workExperienceRoleSchema).min(1, "At least one work experience is required").max(10),
  ...
  job_titles_seeking: z.array(z.string().min(1).max(100)).max(20).default([]),
